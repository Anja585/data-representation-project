...
'All isins' retrive all assets aligible for collateral mobilisation in a list format. Isin (International Securities Identification Number) is a 12-digit alphanumeric code that uniquely identifies a specific security.
